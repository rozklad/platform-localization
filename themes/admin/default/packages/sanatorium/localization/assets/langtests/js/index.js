...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'langtest');

		$('.daterangepicker_end_input').attr('data-grid', 'langtest');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('langtest', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
