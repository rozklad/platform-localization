...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'language');

		$('.daterangepicker_end_input').attr('data-grid', 'language');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('language', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
