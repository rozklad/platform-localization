...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'localization');

		$('.daterangepicker_end_input').attr('data-grid', 'localization');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('localization', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
