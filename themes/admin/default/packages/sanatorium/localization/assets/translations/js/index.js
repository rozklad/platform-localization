...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'translations');

		$('.daterangepicker_end_input').attr('data-grid', 'translations');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('translations', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
